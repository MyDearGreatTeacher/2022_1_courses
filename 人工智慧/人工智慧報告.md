...
- [CNN 卷積神經網路Convolutional Neural Network (CNN)  |CIFAR10](https://www.tensorflow.org/tutorials/images/cnn)
  - [YOUTUBE教學影片20220608_3](https://youtu.be/-SLOloxxoTw)  
  - CIFAR10
...
- [CNN 卷積神經網路Image classification](https://www.tensorflow.org/tutorials/images/classification)
  ...
  - PIL圖片處理套件 PILLOW
    ...
    - [Python 縮放圖片 resize](https://shengyu7697.github.io/python-pil-resize-image/)
    - [Python 圖片模糊化 blur](https://shengyu7697.github.io/python-pil-blur-image/)
    - [Python 讀取圖片並顯示](https://shengyu7697.github.io/python-pil-read-image-and-show-image/)
  - model.compile(
  ...
  - overfitting problem(過度擬合問題)
    - 改進方案1: Data Argumentation(資料擴增法)
    - 改進方案2: Dropout 
  - 最好的報告(完成底下四項測試)
    - 1.沒有改進方案的原始測試
    - 2.只採用改進方案1的測試
